...
- ❌ Don't rely on any assistant's memory of Multi-Framework — the feature is new and still evolving. Point the assistant at this skill + the official docs ([official-sources.md](official-sources.md)).
